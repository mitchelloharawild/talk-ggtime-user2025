...
[<https://xkcd.com/2867/>]{style="position: absolute; top: 10%; left: 0; font-size: 0.9em;"}
...
#| label: loop-timeplot
tsibbledata::aus_production |>
  ggplot(aes(x = Quarter, y = Beer, colour = as.Date(Quarter))) + 
  geom_line() + 
  scale_color_gradientn(labels = \(x) format(structure(x, class = "Date"), "%Y"), colours = scales::hue_pal()(9)) + 
  labs(colour = NULL)
```
